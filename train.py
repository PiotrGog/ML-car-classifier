...
if __name__ == "__main__":
    ...
    if not args.save_history is None:
        save_history(history.history, args.save_history)

    if not args.save_plot is None:
        save_history_plots(history.history, args.save_plot)

    if args.show_plot:
        draw_history_plots(history.history)
